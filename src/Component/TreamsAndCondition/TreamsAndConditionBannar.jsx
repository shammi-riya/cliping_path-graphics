import bannar from '../../assets/privacy-policy/policy.png'

const TreamsAndConditionBannar = () => {
    return (
        ...
        <div className='my-container'>
            <div className='grid mb-3 py-5 lg:px-5 px-10 lg:grid-cols-2 gap-5 grid-cols-1'>
                ...
                <div>
                    < p className='lg:text-xl text-md  font-medium'><span className=' text-lg mb-2 cursor-pointer hover:text-[#ff8a00] transition-all duration-300 ease-in-out'>Home</span>  {'>'} <span className='opacity-70'> Tearm And Condition</span></p>
                ...
                <div>
                    <img className='p-4' src={bannar} alt="privacybannar" />
                </div>
            </div>
        </div>
    </div>
...
export default TreamsAndConditionBannar;